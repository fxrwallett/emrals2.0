Contributing to emrals
============================

The emrals project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/emralsvps-project/emrals/blob/master/doc/translation_process.md)
...
The following applies to code changes to the emrals project, and is not to be
confused with overall emrals Network Protocol consensus changes.

Whether a pull request is merged into emrals rests with the project merge
...
Patches that change emrals consensus rules are considerably more involved than
...
Where a patchset proposes to change the emrals consensus, it must have been
...
The project leader is the release manager for each emrals release.
