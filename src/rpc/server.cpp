...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* emrals features */
        {"emrals", "listmasternodes", &listmasternodes, true, true, false},
        {"emrals", "getmasternodecount", &getmasternodecount, true, true, false},
        {"emrals", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"emrals", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"emrals", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"emrals", "masternodecurrent", &masternodecurrent, true, true, false},
        {"emrals", "masternodedebug", &masternodedebug, true, true, false},
        {"emrals", "startmasternode", &startmasternode, true, true, false},
        {"emrals", "createmasternodekey", &createmasternodekey, true, true, false},
        {"emrals", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"emrals", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"emrals", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"emrals", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"emrals", "getmasternodescores", &getmasternodescores, true, true, false},
        {"emrals", "preparebudget", &preparebudget, true, true, false},
        {"emrals", "submitbudget", &submitbudget, true, true, false},
        {"emrals", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"emrals", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"emrals", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"emrals", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"emrals", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"emrals", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"emrals", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"emrals", "checkbudgets", &checkbudgets, true, true, false},
        {"emrals", "mnsync", &mnsync, true, true, false},
        {"emrals", "spork", &spork, true, true, false},
