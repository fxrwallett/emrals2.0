...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, emralsGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, emralsGUI* gui, double posX = 3);
