...
#include "qt/emrals/topbar.h"
#include "qt/emrals/forms/ui_topbar.h"
#include "qt/emrals/lockunlock.h"
#include "qt/emrals/qtutils.h"
#include "qt/emrals/receivedialog.h"
#include "qt/emrals/loadingdialog.h"
...
TopBar::TopBar(emralsGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopEMRALS}, "amount-small-topbar");
    setCssProperty({ui->labelAmountEMRALS}, "amount-topbar");
    setCssProperty({ui->labelPendingEMRALS, ui->labelImmatureEMRALS}, "amount-small-topbar");
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // EMRALS Total
    QString totalEMRALS = GUIUtil::formatBalance(balance, nDisplayUnit);

    // EMRALS
    // Top
    ui->labelAmountTopEMRALS->setText(totalEMRALS);
    // Expanded
    ui->labelAmountEMRALS->setText(totalEMRALS);
    ui->labelPendingEMRALS->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureEMRALS->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
