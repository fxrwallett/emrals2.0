...
#include "qt/emrals/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/emrals/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(emralsGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableEMRALS,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableEMRALS,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableEMRALS,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableEMRALS,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableEMRALS, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableEMRALS);});
    ...
    if (parent)
        connect(parent, &emralsGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
