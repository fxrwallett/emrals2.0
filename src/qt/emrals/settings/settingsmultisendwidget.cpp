...
#include "qt/emrals/settings/settingsmultisendwidget.h"
#include "qt/emrals/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/emrals/settings/settingsmultisenddialog.h"
    ...
    ui(new Ui::SettingsMultisendWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other Emrals addresses after it matures."));
