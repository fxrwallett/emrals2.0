...
#include "qt/emrals/settings/settingsbackupwallet.h"
#include "qt/emrals/settings/forms/ui_settingsbackupwallet.h"
#include <QFile>
...
#include "qt/emrals/qtutils.h"
SettingsBackupWallet::SettingsBackupWallet(emralsGUI* _window, QWidget *parent) :
