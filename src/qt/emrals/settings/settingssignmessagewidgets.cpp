...
#include "qt/emrals/settings/settingssignmessagewidgets.h"
#include "qt/emrals/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(emralsGUI* _window, QWidget *parent) :
