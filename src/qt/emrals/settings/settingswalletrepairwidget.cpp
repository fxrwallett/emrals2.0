...
#include "qt/emrals/settings/settingswalletrepairwidget.h"
#include "qt/emrals/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/emrals/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(emralsGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to emralsGUI::handleRestart()
