...
#include "qt/emrals/settings/settingsexportcsv.h"
#include "qt/emrals/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(emralsGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("emrals_tx_csv_export(*.csv)") : tr("emrals_addresses_csv_export(*.csv)"),
                                        nullptr);
