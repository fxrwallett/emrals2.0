...
#include "qt/emrals/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(emralsGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &emralsGUI::openFAQ);
