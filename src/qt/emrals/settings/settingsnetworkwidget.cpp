...
#include "qt/emrals/settings/settingsnetworkwidget.h"
#include "qt/emrals/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/emrals/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(emralsGUI* _window, QWidget *parent) :
