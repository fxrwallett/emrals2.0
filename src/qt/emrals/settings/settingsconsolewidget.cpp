...
#include "qt/emrals/settings/settingsconsolewidget.h"
#include "qt/emrals/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/emrals/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(emralsGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the Emrals RPC console.") + "<br>" +
