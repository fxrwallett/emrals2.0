...
#include "qt/emrals/forms/ui_masternodeswidget.h"

#include "qt/emrals/qtutils.h"
#include "qt/emrals/mnrow.h"
#include "qt/emrals/mninfodialog.h"
#include "qt/emrals/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(emralsGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= GetMNCollateral(chainActive.Height()) * COIN) {
        inform(tr("Not enough balance to create a masternode, %1 EMRALS required.").arg(GetMNCollateral(chainActive.Height())));
        return;
    }
    showHideOp(true);
