...
#include "qt/emrals/forms/ui_coldstakingwidget.h"
#include "qt/emrals/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/emrals/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(emralsGUI* parent) :
    PWidget(parent),
