...
#include "qt/emrals/sendcustomfeedialog.h"
#include "qt/emrals/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(emralsGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &emralsGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
