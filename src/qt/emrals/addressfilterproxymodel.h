...
#ifndef emrals_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define emrals_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //emrals_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
