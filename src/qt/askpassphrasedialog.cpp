...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            emralsGUI* window = static_cast<emralsGUI*>(parentWidget());
...
{
    emralsGUI* gui = static_cast<emralsGUI*>(parentWidget());
...
{
    hide();
    static_cast<emralsGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Emrals will close now to finish the encryption process. "
