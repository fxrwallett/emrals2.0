...
This document provides guidelines for internationalization of the emrals software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `emrals_en.ts` remains unchanged.
