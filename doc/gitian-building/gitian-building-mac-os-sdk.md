...
The script [extract-osx-sdk.sh](https://github.com/emralsvps-project/emrals/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
emrals/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/emralsvps-project/emrals/blob/master/doc/README_osx.md) for troubleshooting tips.
