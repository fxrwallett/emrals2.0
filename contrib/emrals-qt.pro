...
RESOURCES += src/qt/emrals.qrc src/qt/emrals_locale.qrc

TRANSLATIONS += src/qt/locale/emrals_bg.ts \
                src/qt/locale/emrals_de.ts \
                src/qt/locale/emrals_en.ts \
                src/qt/locale/emrals_es.ts \
                src/qt/locale/emrals_fi.ts \
                src/qt/locale/emrals_fr.ts \
                src/qt/locale/emrals_it.ts \
                src/qt/locale/emrals_ja.ts \
                src/qt/locale/emrals_pl.ts \
                src/qt/locale/emrals_pt.ts \
                src/qt/locale/emrals_ru.ts \
                src/qt/locale/emrals_sk.ts \
                src/qt/locale/emrals_sv.ts \
                src/qt/locale/emrals_vi.ts \
                src/qt/locale/emrals_zh_CN.ts \
                src/qt/locale/emrals_zh_TW.ts
